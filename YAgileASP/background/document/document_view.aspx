<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="document_view.aspx.cs" Inherits="YAgileASP.background.document.document_view" %>
...
<body style="width:100%;margin:0px;background-color:#EEF5FD;">
    ...
    <table class="editTable" style="width:100%;">
        ...
        <tr>
            <td  colspan="4" style="width:980px">
                <div id="txtDocumentHtml" name="txtDocumentHtml" runat="server" style="width:980px"></div>
            </td>
        </tr>
    </table>
    </div>
